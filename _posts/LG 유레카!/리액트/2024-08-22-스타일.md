...
<h4><span style="color: green">h1</span> {<span style="color: purple">color:</span> <span style="color: brown">green</span>; <span style="color:<span style="color:brown">purple</span>;">font-size:</span> 16px;}</h4>
