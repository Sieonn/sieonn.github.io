...
- [x] D. <span class="hly">IT 직원 비용 제거</span>
...
- [x] B. <span class="hly">연간 예상 사용량만큼 예약 인스턴스를 구입합니다. 스팟 인스턴스에서 계절별 사용량을 실행하도록 허용합니다.</span>
...
- [x] B. <span class="hly">AWS 데이터 파이프라인과 Amazon EC2</span>
...
- [x] E. <span class="hly">EC2에는 자동 스토리지 비용 최적화 기능이 있습니다.</span>
