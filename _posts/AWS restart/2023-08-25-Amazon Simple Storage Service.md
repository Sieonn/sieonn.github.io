...
### Amazon S3 버킷에서 객체를 고유하게 식별하는 속성은 무엇입니까?
...
### Amazon S3는 몇 퍼센트의 내구성을 제공하도록 설계되었습니까?
...
### 한 금융 회사가 장기 스토리지를 위해 가장 낮은 비용의 Amazon S3 솔루션을 사용하고자 합니다. 이 회사는 1년에 한 두 번만 데이터에 액세스하면 됩니다. 다음 중 어떤 Amazon S3 스토리지 클래스를 선택해야 합니까?
...
### Amazon S3를 사용할 때 비용이 발생하는 작업은 무엇입니까?
...
### 다음 중 Amazon S3에 대한 설명은 어느 것입니까? (2개 선택)
